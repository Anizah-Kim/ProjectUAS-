...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2022 at 01:04 PM
...
(1, 'MOTS PERSONA', 'Official', 5, 400, 'PERSONA.jpg'),
(2, 'MOTS PERSONA', 'Official', 5, 400, 'PERSONA.jpg');
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama`, `tanggal_lahir`, `hp`, `alamat`) VALUES
(1, 'alpaca0404', 'lili', 'alpaca c.c', '2012-04-22', '088223344556', 'Bali');
...
--
ALTER TABLE `pemesanan_produk`
  MODIFY `id_pemesanan_produk` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `produk`
--
ALTER TABLE `produk`
  MODIFY `id_produk` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
